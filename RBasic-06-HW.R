...
#' 請問Type有多少種類別？
#' ps. answer6 應該是一個整數
answer6 <- length(levels(CO2$Type)) #請將NULL替換成你的程式碼

#' 請問當類別為Quebec時，uptake的平均值為多少？
answer7 <- mean(CO2[CO2$Type == "Quebec","uptake"]) #請將NULL替換成你的程式碼

#' 請問當類別為Mississippi時，uptake的平均值為多少？
answer8 <- mean(CO2[CO2$Type == "Mississippi","uptake"]) #請將NULL替換成你的程式碼
